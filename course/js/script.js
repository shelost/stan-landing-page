...
let items = [
    ...
    {
        type: 'para',
        content: `This is a course about how to grow your Instagram following by 50%+ just a few simple steps!`
    },
    {
        type: 'subtitle',
        content: 'Module 1'
        ...
        switch (item.type) {
            ...
            case 'subtitle':
                ...
                <div class='sortable'>
                    ...
                    <input class='subtitle' placeholder='Untitled Page' value='${item.content}'>
                </div>`;
                break;
            ...
            case 'subsubtitle':
                ...
                <div class='sortable'>
                    ...
                    <input class='subsubtitle' placeholder='Untitled Page' value='${item.content}'>
                </div>`;
                break;
